...
#############################################################################
#
# This file contains units tests for polynomialdense operations
#                                                                               
#############################################################################
#############################################################################
...
"""
function prod_test_polydense(;N::Int = 10^3, N_prods::Int = 20, seed::Int = 0)
    Random.seed!(seed)
    for _ in 1:N
    ...
    println("prod_test_polydense - PASSED")
end
...
"""
function prod_derivative_test_polydense(;N::Int = 10^2,  seed::Int = 0)
    Random.seed!(seed)
    for _ in 1:N
        p1 = rand(PolynomialDense)
        p2 = rand(PolynomialDense)
    ...
    println("prod_derivative_test_polydense - PASSED")
end
...
"""
function division_test_polydense(;prime::Int = 101, N::Int = 10^4, seed::Int = 0)
    Random.seed!(seed)
    for _ in 1:N
        p1 = rand(PolynomialDense)
        p2 = rand(PolynomialDense)
    ...
    println("division_test_polydense - PASSED")
end

"""
Test the extended euclid algorithm for polynomials modulo p.
"""
function ext_euclid_test_polydense(;prime::Int=101, N::Int = 10^3, seed::Int = 0)
    Random.seed!(seed)
    for _ in 1:N
        p1 = rand(PolynomialDense)
        p2 = rand(PolynomialDense)
